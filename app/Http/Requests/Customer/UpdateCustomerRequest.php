...
class UpdateCustomerRequest extends FormRequest
{
    ...
    {
        return [
            'username' => 'required|string|alpha_dash|max:50|unique:users,username,' . $this->customer->user_id,
            'email' => 'required|email|max:100|unique:users,email,' . $this->customer->user_id,
