...
<div class="grid grid-cols-12 gap-4 md:gap-6">
  <div class="col-span-12">
    ...
    <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/3">
      ...
      <form action="{{ route('customers.store') }}" method="POST" enctype="multipart/form-data" class="border-t border-gray-100 p-5 sm:p-6 dark:border-gray-800 space-y-6">
        @csrf
        ...
        <div class="grid md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input type="text" name="phone" value="{{ old('phone') }}" class="w-full border rounded-lg px-3 py-2 dark:bg-gray-900 dark:border-gray-700 dark:text-white" placeholder="e.g. 08123456789">
          </div>
        </div>
        ...
        <div>
          ...
          <input type="text" name="name" value="{{ old('name') }}" class="w-full border rounded-lg px-3 py-2 dark:bg-gray-900 dark:border-gray-700 dark:text-white" placeholder="Enter customer name" required>
        </div>
...
function addressManager() {
  ...
  const initialAddresses = {!! Js::from($addresses ?? []) !!};
