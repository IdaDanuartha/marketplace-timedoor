  ...
  <div class="col-span-12">
    <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/3">
      ...
      <div class="border-t border-gray-100 p-5 sm:p-6 dark:border-gray-800">
        <form action="{{ route('vendors.update', $vendor) }}" method="POST" enctype="multipart/form-data" x-data="{ switcherToggle: {{ $vendor->is_approved ? 'true' : 'false' }} }">
          @csrf
          @method('PUT')
          ...
          <div class="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input type="text" name="name" value="{{ old('name', $vendor->name) }}" class="w-full border rounded-lg px-3 py-2 dark:bg-gray-900 dark:border-gray-700 dark:text-white">
            ...
            <div>
              ...
              <input type="text" name="username" value="{{ old('username', $vendor->user->username) }}" class="w-full border rounded-lg px-3 py-2 dark:bg-gray-900 dark:border-gray-700 dark:text-white">
            ...
            <div>
              ...
              <input type="email" name="email" value="{{ old('email', $vendor->user->email) }}" class="w-full border rounded-lg px-3 py-2 dark:bg-gray-900 dark:border-gray-700 dark:text-white">
              ...
              <div class="space-y-6 border-t border-gray-100 p-5 sm:p-6 dark:border-gray-800">
                ...
                >
                  ...
                  <div id="preview" class="flex justify-center mb-4 {{ isset($vendor) && $vendor->user->profile_image ? '' : 'hidden' }}">
                    <img id="previewImage" 
                        src="{{ isset($vendor) && $vendor->user->profile_image ? profile_image($vendor->user->profile_image ?? null) : '' }}" 
            ...
            <div class="col-span-2">
              ...
              <textarea name="address" rows="3" class="w-full border rounded-lg px-3 py-2 dark:bg-gray-900 dark:border-gray-700 dark:text-white">{{ old('address', $vendor->address) }}</textarea>
