    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="order-info">
                ...
                <p><strong>Payment Status:</strong> <span style="text-transform: uppercase;">{{ $order->payment_status }}</span></p>
            </div>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right;"><strong>Rp{{ number_format($order->shipping_cost, 0, ',', '.') }}</strong></td>
                    </tr>
                    <tr style="background: #f9fafb;">
                        <td colspan="2" style="text-align: right;"><strong>Grand Total:</strong></td>
                        <td style="text-align: right;" class="total">Rp{{ number_format($order->grand_total, 0, ',', '.') }}</td>
                    </tr>
                </tbody>
            </table>

            <div style="text-align: center;">
                <a href="{{ $invoiceUrl }}" class="button" style="color: #fff !important;">View Detail Invoice</a>
            </div>
