      ...
      <div class="flex items-start justify-between">
        <div>
          ...
          @if ($product->vendor && $product->vendor->is_approved)
            <a href="{{ route('shop.products.index', ['vendor' => $product->vendor->id]) }}" class="flex items-center gap-1 mb-1">
          ...
          @else
            <a href="{{ route('shop.products.index', ['vendor' => $product->vendor->id]) }}" class="text-sm text-gray-500 mb-1">{{ $product->vendor->name ?? '-' }}</a>
          @endif
          ...
          <div class="flex gap-3">
            ...
            <div class="text-gray-500 dark:text-gray-400 mt-1">{{ $product->stock }} in stock</div>
          </div>
        </div>
