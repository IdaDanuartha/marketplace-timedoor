        ...
        <div class="flex flex-col flex-1 w-full lg:w-1/2">
            <div class="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
                <div>
                    ...
                    <?php if($errors->any()): ?>
                        <div class="p-3 mb-4 text-sm text-red-600 bg-red-100 border border-red-300 rounded-lg dark:bg-red-900/20 dark:text-red-400">
                    ...
                    <form method="POST" action="<?php echo e(route('register.post')); ?>" class="space-y-5" x-data="{ loading: false }" @submit.prevent="loading = true; $el.submit()">
                        <?php echo csrf_field(); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="name" value="<?php echo e(old('name')); ?>" required
                                ...
                                class="h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm dark:bg-gray-900 dark:text-white/90 focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10" />
                        </div>
                            ...
                            <div>
                                ...
                                <div x-data="{ showPassword: false }" class="relative">
                                    <input :type="showPassword ? 'text' : 'password'" name="password" required
                                        ...
                                        class="h-11 w-full rounded-lg border border-gray-300 bg-transparent py-2.5 pl-4 pr-11 text-sm dark:bg-gray-900 dark:text-white/90 focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10" />
                        ...
                        <div>
                            <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                Register as<span class="text-error-500">*</span>
                            </label>
                            <select name="role" required
                                class="h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 text-sm dark:bg-gray-900 dark:text-white/90 focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10">
            ...
            <div class="flex items-center justify-center z-1">
                <div class="flex flex-col items-center max-w-xs">
                    <a href="/" class="block mb-4">
                        <img src="<?php echo e(setting('site_logo', asset('images/placeholder-image.svg'))); ?>" class="w-30 rounded-md" alt="Logo" />
                    </a>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/gusde/Documents/laravel/marketplace-timedoor/resources/views/auth/register.blade.php ENDPATH**/ ?>