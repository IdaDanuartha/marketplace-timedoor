      ...
      <div class="space-y-6 border-t border-gray-100 p-5 sm:p-6 dark:border-gray-800">
        <form action="<?php echo e(route('categories.store')); ?>" method="POST">
          ...
          <div class="mb-4">
            ...
            <input type="text" name="name" value="<?php echo e(old('name')); ?>" placeholder="Enter category name"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/gusde/Documents/laravel/marketplace-timedoor/resources/views/admin/categories/create.blade.php ENDPATH**/ ?>