  ...
  >
    ...
    >
      ...
      <a href="index.html" class="lg:hidden">
        <img class="w-18 rounded-full" src="<?php echo e(setting('site_logo', asset('images/placeholder-image.svg'))); ?>" 
      ...
      <div x-data="{ dropdownOpen: false }" class="relative" @click.outside="dropdownOpen = false">
        ...
        >
          <span class="mr-3 h-11 w-11 overflow-hidden rounded-full">
            <img src="<?php echo e(profile_image(auth()->user()->profile_image ?? null)); ?>" alt="User" />
          </span>

          <div>
            <span class="text-theme-sm mr-1 block font-medium">
                <?php echo e(auth()->user()->username ?? 'Unknown User'); ?>

            </span>
            <span class="text-theme-sm mr-1 block capitalize">
          ...
          >
            <path d="M4.3125 8.65625L9 13.3437L13.6875 8.65625" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
        </a>
        ...
        >
          ...
          <ul class="flex flex-col gap-1 border-b border-gray-200 pt-4 pb-3 dark:border-gray-800">
            <li>
              <a
                ...
                class="group flex text-sm items-center gap-3 rounded-lg px-3 py-2 font-medium text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-white/5"
              >
          ...
          <form method="POST" action="<?php echo e(route('logout')); ?>">
            ...
            <button
              type="submit"
              class="group mt-3 flex w-full items-center gap-3 text-sm rounded-lg px-3 py-2 font-medium text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-white/5"
            >
...
</header><?php /**PATH /Users/gusde/Documents/laravel/marketplace-timedoor/resources/views/components/header.blade.php ENDPATH**/ ?>