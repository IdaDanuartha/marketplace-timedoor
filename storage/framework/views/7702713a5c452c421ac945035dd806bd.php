...
unset($__errorArgs, $__bag); ?>
    ...
    <?php if($user->admin): ?>
      <div>
        ...
        <input type="text" name="name" value="<?php echo e(old('name', $user->admin->name)); ?>" placeholder="Full Name"
          class="w-full border rounded-lg px-3 py-2 dark:bg-gray-900 dark:border-gray-700 dark:text-white">
      </div>
    <?php elseif($user->vendor): ?>
      <div class="space-y-4">
        <div>
          ...
          <input type="text" name="name" value="<?php echo e(old('name', $user->vendor->name)); ?>" placeholder="Vendor Name"
            class="w-full border rounded-lg px-3 py-2 dark:bg-gray-900 dark:border-gray-700 dark:text-white">
        </div>
        <div>
    ...
    <?php elseif($user->customer): ?>
      <div class="space-y-4">
        <div>
          ...
          <input type="text" name="name" value="<?php echo e(old('name', $user->customer->name)); ?>" placeholder="Full Name"
            class="w-full border rounded-lg px-3 py-2 dark:bg-gray-900 dark:border-gray-700 dark:text-white">
        </div>
        <div>
          <label class="block text-sm font-medium mb-1">Phone</label>
          <input type="text" name="phone" value="<?php echo e(old('phone', $user->customer->phone)); ?>" placeholder="e.g., +6281234567890"
            class="w-full border rounded-lg px-3 py-2 dark:bg-gray-900 dark:border-gray-700 dark:text-white">
        </div>
      </div>
    <?php endif; ?>
