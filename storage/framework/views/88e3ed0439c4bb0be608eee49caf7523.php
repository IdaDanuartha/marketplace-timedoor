  ...
  <div class="col-span-12">
    <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/3">
      <div class="px-5 py-4 sm:px-6 sm:py-5 flex items-center justify-between">
        <h3 class="text-base font-medium text-gray-800 dark:text-white/90">Edit Vendor</h3>
        <a href="<?php echo e(route('vendors.index')); ?>" class="text-sm text-blue-600 hover:underline">← Back</a>
      </div>

      <div class="border-t border-gray-100 p-5 sm:p-6 dark:border-gray-800">
        <form action="<?php echo e(route('vendors.update', $vendor)); ?>" method="POST" enctype="multipart/form-data" x-data="{ switcherToggle: <?php echo e($vendor->is_approved ? 'true' : 'false'); ?> }">
          <?php echo csrf_field(); ?>
          ...
          <div class="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input type="text" name="name" value="<?php echo e(old('name', $vendor->name)); ?>" class="w-full border rounded-lg px-3 py-2 dark:bg-gray-900 dark:border-gray-700 dark:text-white">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
              ...
              <input type="text" name="username" value="<?php echo e(old('username', $vendor->user->username)); ?>" class="w-full border rounded-lg px-3 py-2 dark:bg-gray-900 dark:border-gray-700 dark:text-white">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
              ...
              <input type="email" name="email" value="<?php echo e(old('email', $vendor->user->email)); ?>" class="w-full border rounded-lg px-3 py-2 dark:bg-gray-900 dark:border-gray-700 dark:text-white">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
              ...
              <input type="password" name="password" class="w-full border rounded-lg px-3 py-2 dark:bg-gray-900 dark:border-gray-700 dark:text-white" placeholder="Leave blank to keep current password">
...
unset($__errorArgs, $__bag); ?>
              ...
              <div class="space-y-6 border-t border-gray-100 p-5 sm:p-6 dark:border-gray-800">
                ...
                >
                  ...
                  <div id="preview" class="flex justify-center mb-4 <?php echo e(isset($vendor) && $vendor->user->profile_image ? '' : 'hidden'); ?>">
                    <img id="previewImage" 
                        src="<?php echo e(isset($vendor) && $vendor->user->profile_image ? profile_image($vendor->user->profile_image ?? null) : ''); ?>" 
            ...
            <div class="col-span-2">
              ...
              <textarea name="address" rows="3" class="w-full border rounded-lg px-3 py-2 dark:bg-gray-900 dark:border-gray-700 dark:text-white"><?php echo e(old('address', $vendor->address)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-span-2 flex items-center gap-3 mt-2">
              <label for="toggle1" class="flex cursor-pointer items-center gap-3 text-sm font-medium text-gray-700 select-none dark:text-gray-400">
                <div class="relative">
                  <input type="checkbox" id="toggle1" name="is_approved" value="1" class="sr-only" @change="switcherToggle = !switcherToggle" :checked="switcherToggle">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/gusde/Documents/laravel/marketplace-timedoor/resources/views/admin/vendors/edit.blade.php ENDPATH**/ ?>