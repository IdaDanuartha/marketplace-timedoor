  ...
  <form method="GET" class="mb-6 grid md:grid-cols-5 gap-4">
    ...
    <div>
        <select name="price" class="select2 w-full" data-placeholder="Price Range">
            ...
            <option value="0-100000" <?php echo e(request('price') == '0-100000' ? 'selected' : ''); ?>>
                Under 100k
            </option>
            <option value="100000-300000" <?php echo e(request('price') == '100000-300000' ? 'selected' : ''); ?>>
                100k - 300k
            </option>
            <option value="300000-500000" <?php echo e(request('price') == '300000-500000' ? 'selected' : ''); ?>>
                300k - 500k
            </option>
            <option value="500000-1000000" <?php echo e(request('price') == '500000-1000000' ? 'selected' : ''); ?>>
                Above 500k
            </option>
        </select>
    </div>
    ...
    <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
      <div class="border rounded-lg bg-white dark:bg-gray-900 dark:border-gray-800 p-4 flex flex-col justify-between relative hover:shadow-md transition">
        ...
        <a href="<?php echo e(route('shop.products.show', $product->slug)); ?>">
          ...
          <?php else: ?>
            <p class="text-xs text-gray-500 mb-1"><?php echo e($product->vendor->name ?? '-'); ?></p>
          <?php endif; ?>
