...
>
  ...
  <div class="flex flex-col overflow-y-auto duration-300 ease-linear no-scrollbar">
    <nav>
      ...
      <?php if(auth()->user()?->vendor && auth()->user()->vendor->is_approved): ?>
        <div>
          <h3 class="mb-4 text-xs uppercase leading-5 text-gray-400"
          ...
          <ul class="flex flex-col gap-4 mb-6">
            ...
            <li>
              <a href="<?php echo e(route('shop.products.index')); ?>"
                class="menu-item group <?php echo e(request()->is('dashboard/shop') || request()->is('dashboard/shop/products*') ? 'menu-item-active' : 'menu-item-inactive'); ?>">
                <svg class="menu-item-icon" width="24" height="24" fill="none" viewBox="0 0 24 24">
                  <path d="M4 4h16v16H4z" stroke="currentColor" stroke-width="1.5"/>
                  <path d="M4 9h16M9 4v16" stroke="currentColor" stroke-width="1.5"/>
                </svg>
            ...
            <li class="relative">
                <a href="<?php echo e(route('shop.wishlist.index')); ?>"
                  class="menu-item group <?php echo e(request()->is('dashboard/shop/wishlist*') ? 'menu-item-active' : 'menu-item-inactive'); ?>">
            ...
            <li class="relative">
                <a href="<?php echo e(route('shop.cart.index')); ?>"
                  class="menu-item group <?php echo e(request()->is('dashboard/shop/cart*') ? 'menu-item-active' : 'menu-item-inactive'); ?>">
            ...
            <li>
              <a href="<?php echo e(route('shop.orders.index')); ?>"
                class="menu-item group <?php echo e(request()->is('dashboard/shop/orders*') ? 'menu-item-active' : 'menu-item-inactive'); ?>">
                <svg class="menu-item-icon" width="24" height="24" fill="none" viewBox="0 0 24 24">
                  <path d="M5 5h14v14H5z" stroke="currentColor" stroke-width="1.5"/>
                  <path d="M8 8h8M8 12h5" stroke="currentColor" stroke-width="1.5"/>
                </svg>
            ...
            <li>
              <a href="<?php echo e(route('shop.reviews.index')); ?>"
                class="menu-item group <?php echo e(request()->is('dashboard/shop/reviews*') ? 'menu-item-active' : 'menu-item-inactive'); ?>">
            ...
            <?php if(auth()->user()?->customer): ?>
              <li>
                <a href="<?php echo e(route('profile.addresses.index')); ?>"
                  class="menu-item group <?php echo e(request()->routeIs('profile.addresses.index') ? 'menu-item-active' : 'menu-item-inactive'); ?>">
